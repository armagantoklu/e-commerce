...
from feedbackType.serializers import FeedBackSerializer


class FeedbackTypeAPIView(generics.GenericAPIView, mixins.ListModelMixin, mixins.CreateModelMixin,
    ...
    def get_object(self):
        ...
        return generics.get_object_or_404(FeedbackType, id=id)
