...
from messageSession.serializers import MessageSessionSerializer


class MessageSessionAPIView(generics.GenericAPIView, mixins.ListModelMixin, mixins.CreateModelMixin,
    ...
    def get_object(self):
        ...
        return generics.get_object_or_404(MessageSession, id=id)
