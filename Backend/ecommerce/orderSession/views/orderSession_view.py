...
from orderSession.serializers import OrderSessionSerializer


class OrderSessionAPIView(generics.GenericAPIView, mixins.ListModelMixin, mixins.CreateModelMixin,
    ...
    def get_object(self):
        ...
        return generics.get_object_or_404(OrderSession, id=id)
