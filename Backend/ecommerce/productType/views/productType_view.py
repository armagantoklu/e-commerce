...
from productType.serializers import ProductTypeSerializer


class ProductTypeAPIView(generics.GenericAPIView, mixins.ListModelMixin, mixins.CreateModelMixin,
    ...
    def get_object(self):
        ...
        return generics.get_object_or_404(ProductType, id=id)
